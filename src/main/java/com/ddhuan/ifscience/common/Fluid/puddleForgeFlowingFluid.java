...
public abstract class puddleForgeFlowingFluid extends ForgeFlowingFluid {
    protected puddleForgeFlowingFluid(Properties properties) {
        super(properties);
    }
    ...
    public static class Source extends puddleForgeFlowingFluid {
    ...
    public static class Flowing extends puddleForgeFlowingFluid {
